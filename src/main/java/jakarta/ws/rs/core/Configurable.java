 ...
 * or {@link jakarta.ws.rs.container.DynamicFeature} meta-providers) or can be directly represented
 * by a concrete JAX-RS component implementing the {@code Configurable} interface
 * (such as {@link jakarta.ws.rs.client.Client} or {@link jakarta.ws.rs.client.WebTarget}).
...
public interface Configurable<C extends Configurable> {
     ...
     * meta-provider contracts, such as {@code Feature} or {@link jakarta.ws.rs.container.DynamicFeature}.
     * <p>
