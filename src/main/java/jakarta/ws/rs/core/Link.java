 ...
 * creating an {@link jakarta.ws.rs.client.Invocation.Builder} or a
 * {@link jakarta.ws.rs.client.WebTarget}.</p>
 *
...
public abstract class Link {
    ...
    /**
     * Convenience method that returns a {@link jakarta.ws.rs.core.UriBuilder}
     ...
     *
     * @param resource a root resource whose {@link jakarta.ws.rs.Path} value will be used
     *                 to initialize the builder.
     * @return a new {@link Link.Builder link builder} instance.
     * @throws IllegalArgumentException if resource is not annotated with {@link jakarta.ws.rs.Path}
     ...
     * @param method   the name of the method whose {@link jakarta.ws.rs.Path} value will be used
     ...
     * that maps the JAX-RS {@link jakarta.ws.rs.core.Link} type to a value that can be
