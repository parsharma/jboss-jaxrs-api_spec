...
public abstract class Response implements AutoCloseable {
     ...
     * a zero-length content, in case the <tt>{@value jakarta.ws.rs.core.HttpHeaders#CONTENT_LENGTH}</tt> and
     * <tt>{@value jakarta.ws.rs.core.HttpHeaders#CONTENT_TYPE}</tt> headers are specified in the message.
