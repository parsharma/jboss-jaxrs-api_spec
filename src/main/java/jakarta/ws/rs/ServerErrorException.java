...
public class ServerErrorException extends WebApplicationException {
     ...
     *                                  {@link jakarta.ws.rs.core.Response.Status.Family#SERVER_ERROR} status code
     *                                  family.
     */
     ...
     *                                  if it is not from the {@link jakarta.ws.rs.core.Response.Status.Family#SERVER_ERROR}
     *                                  status code family.
     */
     ...
     *                                  {@link jakarta.ws.rs.core.Response.Status.Family#SERVER_ERROR} status code family.
     */
