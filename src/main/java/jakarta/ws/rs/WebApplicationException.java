 ...
 * {@link jakarta.ws.rs.core.StreamingOutput} implementation if a specific
...
public class WebApplicationException extends RuntimeException {
    ...
    /**
     * Validate that a {@link jakarta.ws.rs.core.Response} object has an expected HTTP response
     * status code set.
     *
