 ...
 * {@link #target(jakarta.ws.rs.client.WebTarget) SseEventSource.target(endpoint)} factory method to get
 ...
 * <tt>{@value jakarta.ws.rs.core.HttpHeaders#LAST_EVENT_ID_HEADER}</tt> HTTP
 ...
 * In case a <tt>HTTP 503 + {@value jakarta.ws.rs.core.HttpHeaders#RETRY_AFTER}</tt> response is received in return to a connection
...
public interface SseEventSource extends AutoCloseable {
     ...
     * a static {@link SseEventSource#target(jakarta.ws.rs.client.WebTarget) SseEventSource.target(endpoint)} factory method.
     * <p>
     * For example:
     * <pre>
