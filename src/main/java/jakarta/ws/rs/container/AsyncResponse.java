 ...
 * {@link jakarta.ws.rs.HttpMethod resource or sub-resource method} parameter using
 ...
 * </p>
 * <p>
 * By default a timed-out asynchronous response is resumed with a {@link jakarta.ws.rs.WebApplicationException}
 * that has {@link jakarta.ws.rs.core.Response.Status#SERVICE_UNAVAILABLE HTTP 503 (Service unavailable)}
...
public interface AsyncResponse {
     ...
     * returned from a {@link jakarta.ws.rs.HttpMethod JAX-RS resource method}.
     * <p>
     ...
     * by a {@link jakarta.ws.rs.HttpMethod JAX-RS resource method}.
     * <p>
     * By executing this method, the request is guaranteed to complete either successfully or
     ...
     * back a {@link jakarta.ws.rs.core.Response.Status#SERVICE_UNAVAILABLE HTTP 503 (Service unavailable)}
     * error response.
     * </p>
     * <p>
