...
public interface AsyncInvoker {
     ...
     * that wraps a {@link jakarta.ws.rs.ProcessingException} thrown in case of an invocation processing
     * failure.
     ...
     * Note that calling the {@link java.util.concurrent.Future#get()} method on the returned
     * {@code Future} instance may throw an {@link java.util.concurrent.ExecutionException}
     * that wraps either a {@link jakarta.ws.rs.ProcessingException} thrown in case of an invocation processing
     * failure or a {@link WebApplicationException} or one of its subclasses thrown in case the
     * received response status code is not {@link jakarta.ws.rs.core.Response.Status.Family#SUCCESSFUL
     * successful} and the specified response type is not {@link jakarta.ws.rs.core.Response}.
