 ...
 * The main entry point to the API is a {@link jakarta.ws.rs.client.ClientBuilder}
 * that is used to bootstrap {@link jakarta.ws.rs.client.Client} instances -
 * {@link jakarta.ws.rs.core.Configurable configurable}, heavy-weight objects
 ...
 *       {@link jakarta.ws.rs.client.Invocation} for later submission</li>
 * </ol>
 *
 ...
 * An {@link jakarta.ws.rs.client.Invocation} is a request that has been prepared
