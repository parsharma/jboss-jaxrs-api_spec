...
/**
 * Context class used by {@link jakarta.ws.rs.ext.WriterInterceptor}
 * to intercept calls to {@link jakarta.ws.rs.ext.MessageBodyWriter#writeTo}.
...
public interface WriterInterceptorContext extends InterceptorContext {
     ...
     * the wrapped {@link jakarta.ws.rs.ext.MessageBodyWriter#writeTo} method.
     *
