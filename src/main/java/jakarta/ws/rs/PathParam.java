 ...
 * <ul>
 * <li>Be {@link jakarta.ws.rs.core.PathSegment}, the value will be the final
 * segment of the matching part of the path.
 * See {@link jakarta.ws.rs.core.UriInfo} for a means of retrieving all request
 * path segments.</li>
 * <li>Be {@code List<jakarta.ws.rs.core.PathSegment>}, the
 ...
 * <li>Have a registered implementation of {@link jakarta.ws.rs.ext.ParamConverterProvider}
 * JAX-RS extension SPI that returns a {@link jakarta.ws.rs.ext.ParamConverter}
 ...
 * @see jakarta.ws.rs.core.PathSegment
